 ...
 * Generated at: 2023-04-23 14:50:29 UTC
...
public final class RecipeEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	<form action=\"../project/RecipeEdit.do\" method=\"post\" onsubmit=\"return validateForm(this)\" enctype=\"multipart/form-data\">\r\n");
      ...
      out.write("					placeholder=\"예 ) 소고기 미역국 끓이기\" name=\"recipe_name\" value=\"");
      ...
      out.write("					placeholder=\"이 레시피의 탄생배경을 적어주세요. 예) 남편의 생일을 맞아 소고기 미역국을 끓여봤어요. 어머니로부터 배운 미역국 레시피를 남편의 입맛에 맞게 고안했습니다.\">");
      ...
      out.write("			</div>\r\n");
      out.write("			<div>\r\n");
      out.write("<!-- 			<img id=\"mainPhotoHolder\" onclick=\"browseMainFile()\" src=\"../projectResources/img/camera.jpg\" -->\r\n");
      out.write("<!--                   style=\"width: 250px; height: 250px; cursor:pointer\"> -->\r\n");
      out.write("<!-- 				<input type=\"file\" name=\"mainPhotoUpload\" class=\"mainPhotoUpload\" id=\"mainPhotoUpload\" style=\"display: none;\"> -->\r\n");
      out.write("\r\n");
      out.write("<!-- 				<input type=\"file\" id=\"inputFile\" onchange=\"loadFile(event)\" style=\"display:none\"> -->\r\n");
      out.write("				<img id=\"mainPhotoHolder\" src=\"");
      ...
      out.write("\" style=\"width: 250px; height: 250px; cursor:pointer\">\r\n");
      out.write("				<input type=\"file\" id=\"inputFile\" name=\"mainPhotoUpload\" onchange=\"loadMainFile(event)\" style=\"display:none\">\r\n");
      out.write("				\r\n");
      out.write("			</div>\r\n");
      ...
      out.write("</body>\r\n");
      out.write("<script>\r\n");
      out.write("		//요리량, 요리시간, 난이도 선택자 데이터 적용\r\n");
      out.write("        function setSelectValue(selectId, value) {\r\n");
      out.write("            const select = document.getElementById(selectId);\r\n");
      out.write("            const options = Array.from(select.options);\r\n");
      out.write("\r\n");
      out.write("            // 일치하는 값을 찾은 경우 해당 option을 선택합니다.\r\n");
      out.write("            const matchedOption = options.find(option => option.value === value);\r\n");
      out.write("            if (matchedOption) {\r\n");
      out.write("                select.value = value;\r\n");
      out.write("            } else {\r\n");
      out.write("                // 일치하는 값을 찾지 못한 경우 첫 번째 option을 선택합니다.\r\n");
      out.write("                select.selectedIndex = 0;\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("        function init() {\r\n");
      out.write("            // 이 부분에서 실제 값으로 대체해야 합니다.\r\n");
      out.write("            const recipe_people = '");
      ...
      out.write("';\r\n");
      out.write("            const recipe_difficulty = '");
      ...
      out.write("';\r\n");
      out.write("\r\n");
      out.write("            setSelectValue('select_info_1', recipe_people);\r\n");
      out.write("            setSelectValue('select_info_2', recipe_time);\r\n");
      out.write("            setSelectValue('select_info_3', recipe_difficulty);\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        \r\n");
      out.write("        \r\n");
      ...
      out.write("            const mainPhotoHolder = document.getElementById('mainPhotoHolder');\r\n");
      out.write("            const inputFile = document.getElementById('inputFile');\r\n");
      out.write("\r\n");
      out.write("            mainPhotoHolder.addEventListener('click', () => {\r\n");
      out.write("                inputFile.click();\r\n");
      out.write("            });\r\n");
      out.write("\r\n");
      out.write("            inputFile.addEventListener('change', loadMainFile);\r\n");
      out.write("\r\n");
      out.write("            // 함수를 실행하여 이미지 파일 정보를 input에 자동 적용\r\n");
      out.write("            applyImageInfo();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        function loadMainFile(event) {\r\n");
      out.write("            const mainPhotoHolder = document.getElementById('mainPhotoHolder');\r\n");
      out.write("            const file = event.target.files[0];\r\n");
      out.write("            const reader = new FileReader();\r\n");
      out.write("\r\n");
      out.write("            reader.onload = function(e) {\r\n");
      out.write("                mainPhotoHolder.src = e.target.result;\r\n");
      out.write("            };\r\n");
      out.write("\r\n");
      out.write("            reader.readAsDataURL(file);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function applyImageInfo() {\r\n");
      out.write("            const mainPhotoHolder = document.getElementById('mainPhotoHolder');\r\n");
      out.write("            const inputFile = document.getElementById('inputFile');\r\n");
      out.write("            const imagePath = mainPhotoHolder.src;\r\n");
      out.write("\r\n");
      out.write("            // 이미지 파일의 이름을 가져옵니다.\r\n");
      out.write("            const imageName = imagePath.split('/').pop();\r\n");
      out.write("\r\n");
      out.write("            // input에 이미지 정보를 적용합니다.\r\n");
      out.write("            inputFile.value = imageName;\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("      \r\n");
      out.write("        \r\n");
      ...
      out.write("        \r\n");
      out.write("        \r\n");
      out.write("//         //조리방법 사진 파일상태 적용\r\n");
      out.write("//         function displayImage(event, input) {\r\n");
      out.write("//     		event.stopPropagation();\r\n");
      out.write("//             // 파일이 선택되었는지 확인\r\n");
      out.write("//             if (input.files && input.files[0]) {\r\n");
      out.write("//                 // 새 FileReader 인스턴스 생성\r\n");
      out.write("//                 const reader = new FileReader();\r\n");
      out.write("\r\n");
      out.write("//                 // FileReader에 onload 콜백 설정\r\n");
      out.write("//                 reader.onload = function (e) {\r\n");
      out.write("//                     // input id에 해당하는 이미지 요소 가져오기\r\n");
      out.write("//                     const imgId = input.id.replace(\"fileUpload\", \"step_img_photo\");\r\n");
      out.write("//                     const img = document.getElementById(imgId);\r\n");
      out.write("\r\n");
      out.write("//                     // 이미지의 src 속성을 FileReader 결과로 업데이트\r\n");
      out.write("//                     img.src = e.target.result;\r\n");
      out.write("//                 };\r\n");
      out.write("\r\n");
      out.write("//                 // 선택된 이미지 파일을 Data URL로 읽기\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /RecipeProject/RecipeEdit.jsp(24,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /RecipeProject/RecipeEdit.jsp(194,19) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("ingre");
      // /RecipeProject/RecipeEdit.jsp(194,19) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/RecipeProject/RecipeEdit.jsp(194,19) '${ingreList}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${ingreList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n");
            out.write("	                  	<li class=\"ingreTextList\" id=\"ingredient_text_list1\">\r\n");
            out.write("		                  	<input name=\"ingredient_name[]\" type=\"text\" class=\"ingreInput\" placeholder=\"예)돼지고기\" value=\"");
            ...
            out.write("\"></input> \r\n");
            out.write("							<input name=\"ingredient_amount[]\" type=\"text\" class=\"ingreInput\" placeholder=\"예)300g\" value=\"");
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /RecipeProject/RecipeEdit.jsp(234,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("stepList");
      // /RecipeProject/RecipeEdit.jsp(234,5) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/RecipeProject/RecipeEdit.jsp(234,5) '${stepList}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${stepList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("								<textarea name=\"step_text[]\" class=\"form-control step_cont\" placeholder=\"예) 소고기는 기름기를 떼어내고 적당한 크기로 썰어주세요.\">");
            ...
            out.write("								<img name=\"step_img_photo[]\" id=\"step_img_photo1\" class=\"stepDivPhoto\" src=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("/Storage/");
            ...
            out.write("	  							<input type=\"file\" name=\"fileUpload\" class=\"fileUpload\" id=\"fileUpload1\" style=\"display: none;\" multiple=\"multiple\" onchange=\"displayImage(event, this)\">\r\n");
            out.write("	  						</div>\r\n");
            out.write("	  										\r\n");
