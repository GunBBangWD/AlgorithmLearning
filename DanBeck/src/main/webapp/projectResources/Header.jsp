...
<!--            <button>검색</button> -->
        ...
        <ul class="nav nav-pills" id="main-menu">
          ...
          <li class="nav-item"><a href="../project/recipeList.do" class="nav-link active">Recipes</a></li>
          <li class="nav-item"><a href="../project/recipeWrite.do" class="nav-link">Write</a></li>
